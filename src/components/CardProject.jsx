...
const CardProject = (props) => {
  return (
    <div className="h-full max-w-[343px] rounded border border-black shadow-[3px_3px_0px_black] duration-300 hover:shadow-[5px_5px_10px_black]">
      <img
        src={props.data.img}
      ...
      <div className="m-[2px] flex items-center justify-center gap-2 rounded-bl rounded-br bg-black p-2 text-center text-white">
        <a
          ...
          target="_blank"
          className="rounded border border-white px-3 py-1 transition duration-300 hover:-translate-y-1 hover:bg-white hover:text-black"
        >
          View Demo
        </a>
        <a
