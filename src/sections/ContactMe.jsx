...
const ContactMe = () => {
  return (
    <div className="flex w-full flex-col items-center justify-center gap-4 font-gilroy xl:py-40">
      <h1 className="text-center text-[22px] font-bold text-black sm:text-3xl">
        Contact me
      </h1>
      <div className="text-center sm:text-lg">
        <p className="text-[14px] font-normal text-black sm:text-base">
          Address
        </p>
      ...
      <div className="text-center">
        <p className="text-[14px] font-normal text-black sm:text-base">Email</p>
        <p className="text-[14px] font-medium sm:text-base">
